    ...
    this.draw = function (dataComponent$1854) {
		...
		*/
        ...
        if (typeof document.querySelector(this.container + ' .animated-background') !== 'undefined' && document.querySelector(this.container + ' .animated-background') === null) {
            animateContentEl$1914 = addClass$1880('animated-background')(appendIn$1890(document.querySelector(this.container))(document.createElement('div')));
        } else {
            animateContentEl$1914 = document.querySelector(this.container + ' > ' + '.animated-background');
        }
        ...
        if (dataDefault$1856.right) {
            ...
            if (//div before, beacause is in bottom.
                ...
                })(size$1870('100%', this.marginLeftOfSide)(addClass$1880('background-masker')(appendIn$1890(animateContentEl$1914)(document.createElement('div')))));
            ...
            this.marginTopElement = position$1912({
                ...
                left: 0
            })(size$1870('100%', dataDefault$1856.marginTop)(addClass$1880('background-masker')(appendIn$1890(animateContentEl$1914)(document.createElement('div')))));
            this.sideLeftElement = position$1912({
                top: topPositionElement$1923 + 'px',
                left: 0
            })(size$1870(widthElement$1931 + 'px', dataDefault$1856.height)(addClass$1880('background-masker')(appendIn$1890(animateContentEl$1914)(document.createElement('div')))));
            this.sideRightElement = position$1912({
                top: topPositionElement$1923 + 'px',
                right: 0
            })(size$1870(dataDefault$1856.center ? widthElement$1931 + 'px' : sideSizeX$1929 + 'px', dataDefault$1856.height)(addClass$1880('background-masker')(appendIn$1890(animateContentEl$1914)(document.createElement('div')))));
